...
canonical couplings M=-i*xi (moduli_scan/fcnc_lib.py) and extract the CP-violating signal,
...
Output (moduli_scan/data/combined_complex.json):
...
Usage: python moduli_scan/aggregate_complex.py [--runs-dir moduli_scan/data/runs]
                                        [--out moduli_scan/data/combined_complex.json]
"""
...
ap.add_argument("--out", default="moduli_scan/data/combined_complex.json")
args = ap.parse_args()
