...
(moduli_scan/aggregate_fcnc.py output).
...
Usage: python moduli_scan/plots/plot_fcnc.py [--combined moduli_scan/data/combined_fcnc.json]
...
ap.add_argument("--combined", default="moduli_scan/data/combined_fcnc.json")
