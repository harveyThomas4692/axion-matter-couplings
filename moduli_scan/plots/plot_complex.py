...
Usage: python moduli_scan/plots/plot_complex.py [--combined moduli_scan/data/combined_complex.json]
                                    [--runs-dir moduli_scan/data/runs]
...
ap.add_argument("--combined", default="moduli_scan/data/combined_complex.json")
