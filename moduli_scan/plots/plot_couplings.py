#!/usr/bin/env python3
"""
Plot axion-matter couplings vs psi1 from combined.json (moduli_scan/aggregate.py output).
...
Usage:
  python moduli_scan/plots/plot_couplings.py [--combined moduli_scan/data/combined.json]
...
ap.add_argument("--combined", default="moduli_scan/data/combined.json")
