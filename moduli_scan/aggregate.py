...
Usage:  python moduli_scan/aggregate.py [--runs-dir moduli_scan/data/runs] [--out moduli_scan/data/combined.json]
"""
...
ap.add_argument("--out", default="moduli_scan/data/combined.json")
args = ap.parse_args()
